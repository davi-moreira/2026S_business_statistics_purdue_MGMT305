...
- Week 2: the positive forecast error indicates that the forecasting method underestimated the actual value of sales.
...
- To make comparisons like these we need relative or percentage error measures like **MAPE**.
...
- The trend line provides a reasonable approximation to the long-run movement in the series.
