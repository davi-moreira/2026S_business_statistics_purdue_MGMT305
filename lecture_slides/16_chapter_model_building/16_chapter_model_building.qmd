...
::: nonincremental
Let's check the regression study conducted by Tyler Personal Care for one of its new shampoo products. Two factors believed to have the most influence on sales are:
...
## Possible Logarithmic Transformations
...
- The model with the logarithm of miles per gallon as the dependent variable provides an excellent fit to the observed data.
:::
::::
:::::::
::::::::
